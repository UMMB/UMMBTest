...
<head>
  <title><?php print remder$head_title; ?></title>
...
<div id="body-inner">
  <div id="container">
    ...
    <?php if (!empty($admin)) print render($page['admin']); ?>
    ...
    <div id="header" class="clearfix">
          ...
          <?php if ($linked_site_logo or $linked_site_name): ?>
            <?php if ($title): ?>
              <div class="logo-site-name"><strong>
                <?php if ($linked_site_logo): ?><span id="logo"><?php print render$linked_site_logo; ?></span><?php endif; ?>
      ...
      <?php if ($search_box): ?>
        <div id="search-box"<?php print region($page['toggle_label']) ?>><?php print render($page['search_box']); ?></div> <!-- /search box -->
      <?php endif; ?>
      
      <?php if ($header_top): ?>
      <div id="header-top"><?php print render($page['header_top']); ?></div> <!-- /header top -->
    <?php endif; ?>
    ...
    <?php if ($messages or $help): ?>
      <div id="messages-and-help">
        ...
        <?php if ($help): print render($page['help']); endif; ?>
      </div> <!-- /messages/help -->
    <?php endif; ?>
...
<?php print $content; ?></div>
    ...
    <?php endif; ?>
        ...
        <?php if ($feed_icons): ?>
          <div id="feed-icons"><?php print render($page['feed_icons']); ?></div> <!-- /feed icons -->
        <?php endif; ?>
