...
*   A form array.
*/
function lederle_settings($saved_settings) {
  
  // Get the default values from the .info file.
  $defaults = adaptivetheme_theme_get_default_settings('lederle');
  ...
  if ($settings['color_enable_schemes'] == 'on') {
    ...
    $form['color']['color_schemes'] = array(
      ...
      '#options' => array(
        'colors-maroon.css' => t('Maroon'),
        'colors-black.css' => t('Black'), 
				'colors-gray.css' => t('Gray'),      
