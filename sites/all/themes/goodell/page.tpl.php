...
<!--[if lt IE 7 ]> <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" class="ie6"> <![endif]-->
<!--[if IE 7 ]>    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" class="ie7"> <![endif]-->
<!--[if IE 8 ]>    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" class="ie8"> <![endif]-->
<!--[if IE 9 ]>    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" class="ie9"> <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!--> 

<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>"> <!--<![endif]-->
...
<body class="<?php print render($page['classes']); ?>">
  <div id="container">

    <div id="skip-nav" class="<?php print render($class['skip_nav_class']); ?>">
    ...
    <?php if (!empty($admin_user_links)): ?>
      <div id="user-menu" class="clearfix">
        ...
        <?php print render($page['admin_user_links']); ?>
      </div> <!-- /admin user link -->
    <?php endif; ?>

    <?php if ($leaderboard): ?>
      <div id="leaderboard"><?php print render($page['leaderboard']); ?></div> <!-- /leaderboard -->
    <?php endif; ?>
    ...
    <div id="header" class="clearfix">
          ...
          <?php if ($linked_site_logo or $linked_site_name): ?>
            <?php if ($title): ?>
              <div class="logo-site-name"><strong>
                ...
                <?php if ($linked_site_name): ?><span id="site-name"><?php print render($page['linked_site_name']); ?></span><?php endif; ?>
              </strong></div> <!-- /logo/site name -->
            <?php else: /* Use h1 when the content title is empty */ ?>
              <h1 class="logo-site-name">
                <?php if ($linked_site_logo): ?><span id="logo"><?php print render($page['linked_site_logo']); ?></span><?php endif; ?>
                <?php if ($linked_site_name): ?><span id="site-name"><?php print render($page['linked_site_logo']); ?></span><?php endif; ?>
              </h1> <!-- /logo/site name -->
            <?php endif; ?>
          <?php endif; ?>

          <?php if ($site_slogan): ?>
            <div id="site-slogan"><?php print render($page['site_slogan']); ?></div> <!-- /slogan -->
          <?php endif; ?>
      ...
      <?php if ($search_box): ?>
        <div id="search-box"<?php print render($page['toggle_label']); ?>><?php print render($page['search_box']); ?></div> <!-- /search box -->
      <?php endif; ?>
    ...
    <?php if ($messages or $help): ?>
      <div id="messages-and-help">
        ...
        <?php if ($messages): print render($page['messages']); endif; ?>
        ...
        <div id="main-content">
          ...
          <?php if ($title or $tabs): ?>
            <div id="main-content-header">
              <?php if ($title): ?><h1 id="page-title"><?php print render($page['title']); ?></h1><?php endif; ?>
              <?php if ($tabs): ?>
