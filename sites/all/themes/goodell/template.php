...
if (theme_get_setting('color_enable_schemes') == 'on') {
  drupal_add_css(drupal_get_path('theme', 'goodell') .'/css/theme/'. get_at_colors(), 'theme');
}
 ...
 */
/*
function goodell_preprocess(&$vars, $hook) {
 ...
 */
/*
function goodell_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function goodell_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function goodell_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function goodell_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/

/**
 * Here's a simple code snippet that allows the use of global tokens (via the
 * token module) in the footer message variable: 
 *
 * http://geminiloop.com/blog/201006/use-tokens-drupal-variables
 */

function phptemplate_preprocess_page(&$vars) {
  if (module_exists('token')) {
    $vars['footer_message'] = token_replace($vars['footer_message']);
  }
}
